...
Y.mix(Y.DOM, {
    ...
    _create: function(html, doc, tag) {
        ...
        // Jira ticket - CER-37
        frag.innerHTML = DOMPurify.sanitize(html);
...
if (!testFeature('innerhtml-div', 'script')) {
    creators.script = function(html, doc) {
        ...
        var newDoc = parser.parseFromString('-' + DOMPurify.sanitize(html), 'text/html');
        frag.appendChild(newDoc.body.firstElementChild);
        // BGWS Modification END
